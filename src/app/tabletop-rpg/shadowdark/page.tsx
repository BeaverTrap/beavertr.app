        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="card bg-base-100 hover:bg-base-200 transition-colors duration-300 shadow-lg">
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <button
                  onClick={() => router.push("/tabletop-rpg/shadowdark/characterbuilder")}
                  className="btn btn-primary font-shadowdarkEntry"
                >
                  Get Started
                </button>
          ...
          <div className="card bg-base-100 hover:bg-base-200 transition-colors duration-300 shadow-lg">
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <button
                  onClick={() => router.push("/tabletop-rpg/shadowdark/campaigns")}
                  className="btn btn-primary font-shadowdarkEntry"
                >
                  View Campaigns
                </button>
              ...
              <div className="card-actions justify-end">
                <button
                  onClick={() => {
                    ...
                    router.push("/tabletop-rpg/shadowdark/dm");
                  }}
                  className="btn btn-primary font-shadowdarkEntry"
                >
                  Open Dashboard
